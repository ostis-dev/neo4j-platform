...
sentence: sentence_lvl1 | sentence_lvl_common; // level 1
...
idtf_lvl1: (idtf_lvl1_preffix '#')? ID_SYSTEM;

idtf_system: ID_SYSTEM;

idtf_edge: '(' idtf_system connector attr_list? idtf_system ')';
...
sentence_lvl_4_list: ( connector attr_list? idtf_list);

sentence_lvl_common:
	idtf_common sentence_lvl_4_list (';' sentence_lvl_4_list)*;
